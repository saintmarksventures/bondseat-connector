...
export const tools = [
  ...
  ['status', 'Read booking status. Without an ID, finish pending setup. Honor pollAfterSeconds. Credentials are managed automatically. FIRED monitor outcome or SUCCEEDED scheduled status means booked.', { kind: reference.kind.optional(), id: reference.id.optional() }, true],
  ...
  ['stop', 'Stop future attempts when requested. This cannot cancel a restaurant reservation; an in-flight booking may finish.', reference, false],
